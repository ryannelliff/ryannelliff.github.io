      ...
      <header className="bg-white">
        <div className="navbar px-6 py-4">
          <div className="flex-1">
            <a className="text-2xl font-bold text-primary">Ryann Elliff</a>
          </div>
          <div className="flex-none gap-8">
            <a href="#projects" className="text-black hover:text-primary font-medium">Projects</a>
            <a href="#about" className="text-black hover:text-primary font-medium">About</a>
            <a href="#contact" className="text-black hover:text-primary font-medium">Contact</a>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-white py-8 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 mt-4">
            <a href="https://www.linkedin.com/in/ryann-elliff-mba-5b431624a/" className="text-primary hover:text-primary-dark font-medium text-sm">LinkedIn</a>
            <a href="https://www.instagram.com/ryannelliff/" className="text-primary hover:text-primary-dark font-medium text-sm">Instagram</a>
            <a href="mailto:reelliff@gmail.com" className="text-primary hover:text-primary-dark font-medium text-sm">Email</a>
          </div>
        </div>
      </footer>
    </div>
